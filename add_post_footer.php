		...
		<form name="formapf" method="post" action="' . $_SERVER['REQUEST_URI'] . '">
			...
			<fieldset class="options">
				<legend>Related Post List:<br />
					...
					<p>You can customize style of post list by adding <b>"#apf_post_footer"</b> and <b>"li.apf_post_footer"</b> to your main CSS file. <a href="http://www.freetimefoto.com/add_post_footer_plugin_wordpress#relate_post">more info</a></p>
					<p>
			...
			<p>Keep Plugin credit: <font color="red"><b>'. $options["apf_add_credit"] . '</b></font>&nbsp;
			...
			<p>Please refer to <a href="http://www.freetimefoto.com/add_post_footer_plugin_wordpress#custom_field">Add Post Footer Plugin page</a> for complete list of custom field key and value</p>
			<p class="submit">
